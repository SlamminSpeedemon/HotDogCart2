...
hotdogObject.guiStart(labelsXpos, labelsYPos)

bratObject = Item(bratCost, "brats", root)
bratObject.guiStart(labelsXpos, labelsYPos + labelYposChanger)

hamburgerObject = Item(hamburgerCost, "hamburgers", root)
hamburgerObject.guiStart(labelsXpos, labelsYPos + 2 * labelYposChanger)

friesObject = Item(sodaCost, "fries", root)
friesObject.guiStart(labelsXpos, labelsYPos + 3 * labelYposChanger)

sodasObject = Item(sodaCost, "sodas", root)
sodasObject.guiStart(labelsXpos, labelsYPos + 4 * labelYposChanger)

watersObject = Item(0, "waters", root)
watersObject.guiStart(labelsXpos, labelsYPos + 5 * labelYposChanger)
